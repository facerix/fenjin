...
dojo.provide("fen.Font");
dojo.require("fen.ImageCache");

dojo.declare("fen.Font", null, {
    timerid: 0,
    initialized: false,
    teletype: false,
    constructor: function font_constructor(args){
        ...
        if (!(window.imageCache.hasImage("font"))) { window.imageCache.addImage("font", "fen/res/font.png"); };
        this.imgSrc = "font";
        this.initialized = true;
    },
